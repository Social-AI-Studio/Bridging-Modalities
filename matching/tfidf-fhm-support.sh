...
python3 tfidf_wrapper.py \
    ...
    --output_filepath /mnt/data1/datasets/memes/cmtl-rag/sim_matrices_finalized/textcaption2textcaption/fhm_fhm_tfidf_matching.npy \
    --overwrite
...
python3 tfidf_wrapper.py \
    ...
    --output_filepath /mnt/data1/datasets/memes/cmtl-rag/sim_matrices_finalized/textcaption2rationale/fhm_fhm_tfidf_matching.npy \
    --overwrite
...
python3 tfidf_wrapper.py \
    ...
    --support_caption_dirs $FHM_ALIGNMENT_CAPTIONS \
    --support_content content_text_caption \
    --output_filepath /mnt/data1/datasets/memes/cmtl-rag/sim_matrices_finalized/textcaption2textcaption/mami_fhm_tfidf_matching.npy \
    --overwrite
...
python3 tfidf_wrapper.py \
    ...
    --support_caption_dirs $FHM_ALIGNMENT_CAPTIONS \
    --support_content rationale \
    --output_filepath /mnt/data1/datasets/memes/cmtl-rag/sim_matrices_finalized/textcaption2rationale/mami_fhm_tfidf_matching.npy \
    --overwrite
