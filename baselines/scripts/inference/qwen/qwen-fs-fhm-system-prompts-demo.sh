...
do
    ...
    python3 -u ../../../prompt-qwen-fs.py \
        ...
        --feature_dir "" \
        --result_dir ../../../results/baselines/system_prompt_demonstrations/$EXP_NAME/$1/$MODEL/fhm_finegrained/bm25 \
        --prompt_format "system_prompt_demonstrations" \
        --use_demonstrations \
        ...
        --shots $EXP > ../../logs/system_prompt_demonstrations/$EXP_NAME/$1/$MODEL/fhm-bm25.log
