...
do
    ...
    python3 ../../prompt-mistral-fs.py \
        ...
        --shots $EXP > ../../logs/${EXP}_shots/$MODEL/fhm-random.log
    ...
    python3 ../../prompt-mistral-fs.py \
        ...
        --support_feature_dirs "" \
        --sim_matrix_filepath $FHM_TFIDF \
        --shots $EXP > ../../logs/${EXP}_shots/$MODEL/fhm-tfidf.log
    ...
    python3 ../../prompt-mistral-fs.py \
        ...
        --shots $EXP > ../../logs/${EXP}_shots/$MODEL/fhm-bm25.log
    ...
    python3 ../../prompt-mistral-fs.py \
        ...
        --shots $EXP > ../../logs/${EXP}_shots/$MODEL/mami-random.log
    ...
    python3 ../../prompt-mistral-fs.py \
        ...
        --support_feature_dirs "" \
        --sim_matrix_filepath $MAMI_TFIDF \
        --shots $EXP > ../../logs/${EXP}_shots/$MODEL/mami-tfidf.log
    ...
    python3 ../../prompt-mistral-fs.py \
        ...
        --shots $EXP > ../../logs/${EXP}_shots/$MODEL/mami-bm25.log
done